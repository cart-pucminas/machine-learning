...
-- *****************************************************************************
-- Generated on "04/28/2018 11:40:24"
                                                             
-- Vhdl Test Bench(with test vectors) for design  :          Kmodes_CalcMapModule
-- 
...
ENTITY Kmodes_CalcMapModule_vhd_vec_tst IS
END Kmodes_CalcMapModule_vhd_vec_tst;
ARCHITECTURE Kmodes_CalcMapModule_arch OF Kmodes_CalcMapModule_vhd_vec_tst IS
-- constants                                                 
-- signals                                                   
SIGNAL addr_Ram_Centroid : STD_LOGIC_VECTOR(13 DOWNTO 0);
SIGNAL addr_Ram_Dado : STD_LOGIC_VECTOR(13 DOWNTO 0);
SIGNAL centroid : STD_LOGIC_VECTOR(63 DOWNTO 0);
SIGNAL clk : STD_LOGIC;
SIGNAL dado : STD_LOGIC_VECTOR(63 DOWNTO 0);
SIGNAL DistanceMatch : STD_LOGIC_VECTOR(3 DOWNTO 0);
SIGNAL en_KmodesControlCalcMap : STD_LOGIC;
SIGNAL EndDistanceMatch : STD_LOGIC;
SIGNAL enMinDistMatch : STD_LOGIC;
SIGNAL enSimpleMatch : STD_LOGIC;
SIGNAL KmodesEstatoMap : STD_LOGIC_VECTOR(3 DOWNTO 0);
SIGNAL KmodesSumDist : STD_LOGIC_VECTOR(6 DOWNTO 0);
SIGNAL next_State : STD_LOGIC_VECTOR(3 DOWNTO 0);
SIGNAL nrst : STD_LOGIC;
SIGNAL o_dado : STD_LOGIC_VECTOR(9 DOWNTO 0);
SIGNAL oReg7 : STD_LOGIC_VECTOR(9 DOWNTO 0);
...
COMPONENT Kmodes_CalcMapModule
	PORT (
...
-- list connections between master ports and signals
	...
	en_KmodesControlCalcMap => en_KmodesControlCalcMap,
	EndDistanceMatch => EndDistanceMatch,
	enMinDistMatch => enMinDistMatch,
	enSimpleMatch => enSimpleMatch,
	KmodesEstatoMap => KmodesEstatoMap,
	KmodesSumDist => KmodesSumDist,
...
-- en_KmodesControlCalcMap
t_prcs_en_KmodesControlCalcMap: PROCESS
BEGIN
	en_KmodesControlCalcMap <= '1';
WAIT;
END PROCESS t_prcs_en_KmodesControlCalcMap;
-- reg1[9]
