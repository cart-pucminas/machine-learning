...
-- *****************************************************************************
-- Generated on "04/10/2017 11:49:31"
                                                             
-- Vhdl Test Bench(with test vectors) for design  :          Kmeans_CalcMapModule
-- 
...
ENTITY Kmeans_CalcMapModule_vhd_vec_tst IS
END Kmeans_CalcMapModule_vhd_vec_tst;
ARCHITECTURE Kmeans_CalcMapModule_arch OF Kmeans_CalcMapModule_vhd_vec_tst IS
-- constants                                                 
-- signals                                                   
...
SIGNAL distanceSum : STD_LOGIC_VECTOR(127 DOWNTO 0);
SIGNAL en_ControlCalcMap : STD_LOGIC;
...
COMPONENT Kmeans_CalcMapModule
	PORT (
	...
	distanceSum : OUT STD_LOGIC_VECTOR(127 DOWNTO 0);
	en_ControlCalcMap : IN STD_LOGIC;
...
-- list connections between master ports and signals
	...
	en_ControlCalcMap => en_ControlCalcMap,
	endCalc => endCalc,
...
-- en_ControlCalcMap
t_prcs_en_ControlCalcMap: PROCESS
BEGIN
	en_ControlCalcMap <= '1';
WAIT;
END PROCESS t_prcs_en_ControlCalcMap;
-- reg1[9]
